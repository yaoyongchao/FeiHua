...
public class AppDownloadManager {
    ...
    private String appName = "dayiketang.apk";
...
//        File apkFile = new File(weakReference.get().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), "weicai.apk");
        File apkFile = new File(weakReference.get().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), appName);
...
//                        "com.vcaidian.customer.provider",
